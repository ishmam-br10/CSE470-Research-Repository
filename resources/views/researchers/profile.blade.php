                    ...
                    <div class="flex flex-col md:flex-row border-b pb-6 mb-6">
                        ...
                        <div class="md:w-1/4 flex justify-start items-start mb-4 md:mb-0">
                            @if($researcher->avatar_path)
                                <div class="w-40 h-40 rounded-full overflow-hidden border-2 border-gray-200 shadow-sm">
                                    <img src="{{ Storage::url($researcher->avatar_path) }}" alt="{{ $researcher->name }}" 
                                        class="w-full h-full object-cover">
                                </div>
                            @else
                                <div class="w-40 h-40 bg-gray-300 flex items-center justify-center text-xl text-gray-700 border-2 border-gray-200 shadow-sm rounded-full">
