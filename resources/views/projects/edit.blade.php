                ...
                <div class="p-6">
                    <form action="{{ route('projects.update', $project) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="description" name="description" rows="6" class="block mt-1 w-full border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 rounded-md shadow-sm" required>{{ old('description', $project->description) }}</textarea>
